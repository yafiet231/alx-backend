...
+ [x] 3. **Parametrize templates**
  ...
  + Compile your dictionaries with:
    ...
    ```
  + Reload the home page of the app and make sure that the correct messages show up.
...
+ [x] 5. **Mock logging in**
  ...
  + In your HTML template, if a user is logged in, in a paragraph tag, display a welcome message display a default message.
